...
|EnableServerAuth| Specifies whether Org policy URL (AzSDKServerURL) is protected by AAD authentication.| e.g. true - protected by AAD authentication, false - not protected by AAD authentication|
