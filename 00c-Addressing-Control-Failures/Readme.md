...
### [Control Attestation](00c-Addressing-Control-Failures#control-attestation-1)
- [Overview](00c-Addressing-Control-Failures#overview)  
- [Starting attestation](00c-Addressing-Control-Failures#starting-attestation)  
- [How AzSDK determines the effective control result](00c-Addressing-Control-Failures#how-azsdk-determines-the-effective-control-result)  
- [Permissions required for attesting controls](00c-Addressing-Control-Failures#permissions-required-for-attesting-controls)  
### [Fix Control Script](00c-Addressing-Control-Failures#fix-control-script-1)
- [Overview](00c-Addressing-Control-Failures#overview-1)  
- [How to generate fix script?](00c-Addressing-Control-Failures#how-to-generate-fix-script)  
- [How to run fix script generated by AzSDK?](00c-Addressing-Control-Failures#how-to-run-fix-script-generated-by-azsdk)  
- [Repair-AzSDKSubscriptionSecurity](00c-Addressing-Control-Failures#repair-azsdksubscriptionsecurity)  
- [Repair-AzSDKAzureServicesSecurity](00c-Addressing-Control-Failures#repair-azsdkazureservicessecurity)  
----------------------------------------------------------------
# Control Attestation
