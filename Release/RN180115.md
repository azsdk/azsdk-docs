...
* Continuous Assurance:
	...
	* Added support for specifying a webhook in CA setup to facilitate downstream extensibility scenarios (e.g., this can be used to 'listen' to CA scan events and generate SNOW tickets for certain critical issues).
